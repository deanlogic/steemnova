...
$LNG['sys_tran_mess_back'] 					= 'One of your fleets has return from the planet %s %s.';
$LNG['sys_trade_mess_back'] 					= 'One of your trading fleets has return to the planet %s %s without success.';
...
$LNG['sys_gain'] 				  			= 'Profit';
$LNG['sys_fleet_won'] 						= 'One of your fleets has return from a attack at the planet %s %s. You have captured %s %s, %s %s and %s %s ';
$LNG['sys_lost'] 							= 'Losses';
...
$LNG['sys_destruc_reussi']      		   	= 'The deathstars beams reached the moon and tore it to pieces. <br>The entire moon was destroyed.';
